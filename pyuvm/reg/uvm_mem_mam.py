...
from pyuvm import uvm_object, uvm_sequence_base, uvm_void
...
class uvm_mem_region(uvm_void):
    ...
    def get_virtual_registers(self,) -> uvm_vreg:
        raise NotImplementedError
    ...
    async def burst_read(
            ...
            extension: uvm_object = None,
            fname: str = "",
            lineno: int = 0) -> tuple[uvm_status_e, list[uvm_reg_data_t]]:
        raise NotImplementedError
