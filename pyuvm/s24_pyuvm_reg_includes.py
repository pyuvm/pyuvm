...
'''
enable_pyvsc                            = False ## Global to be set in case we wanna use the VSC package
enable_auto_predict                     = True  ## Global to be set in case we wanna use the auto prediction
enable_throw_error_response_on_read     = False ## Global enable bit for error response in case of NO-EFFECT action based on the access type
enable_throw_error_response_on_write    = False ## Global enable bit for error response in case of NO-EFFECT action based on the access type
disable_code_interruption_assert        = False ## Global assert disable this is used in order to avoid code interruption by just checking for the error list
'''
enable_pyvsc                            = False 
