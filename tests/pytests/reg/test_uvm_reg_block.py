...
def model():
    ...
    class Model(uvm_reg_block):
        def __init__(self, name="block"):
            ...
            map = self.create_map("map", 0x0, 4, uvm_endianness_e.UVM_LITTLE_ENDIAN, False)
...
def test_reg_block_get_field_sub_reg_block():
    ...
    class temp_blk_1(uvm_reg_block):
        def __init__(self, name="temp_blk_1"):
            super().__init__(name)
            self.def_map = self.create_map("blk_1_map", 0x0, 4, uvm_endianness_e.UVM_LITTLE_ENDIAN)
...
def test_reg_map_with_multiple_regs():
    ...
    reg_map = reg_block.create_map("reg_map", 0x0, 1, uvm_endianness_e.UVM_LITTLE_ENDIAN, False)
    reg0 = uvm_reg("reg0", 8)
    reg1 = uvm_reg("reg1", 8)
...
def test_reg_block_get_reg_by_name():
    ...
    class temp_blk_1(uvm_reg_block):
        def __init__(self, name="temp_blk_1"):
            ...
            self.def_map.configure(self, 0x0, 4, uvm_endianness_e.UVM_LITTLE_ENDIAN, False)
...
def test_reg_block_get_field_by_name():
    ...
    class temp_blk_1(uvm_reg_block):
        def __init__(self, name="temp_blk_1"):
            super().__init__(name)
            self.def_map = uvm_reg_map("blk_1_map")
            self.def_map.configure(self, 0x0, 4, uvm_endianness_e.UVM_LITTLE_ENDIAN, True)
